    ...
    <div className="welcome">
      <div className="welcome-page-container">
        ...
        <div className="admin-links">
          ...
          <ul>
            <li>
              <Link to="/admin/add-user">הוספת משתמש</Link>
            </li>
            <li>
              <Link to="/admin/edit-role">עריכת תפקיד</Link>
            </li>
            <li>
              <Link to="/admin/user-list">רשימת משתמשים</Link>
            </li>
            <li>
              <Link to="/admin/student-details">פרטי סטודנט</Link>
            </li>
          </ul>
        </div>
      </div>
